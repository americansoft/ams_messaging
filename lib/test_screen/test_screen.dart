      ...
      body: Stack(
        children: [
          ListView(
            ...
            children: const [
              _ChatBubble('عينيا', time: '10:03 am', isSender: false),
              VideoMessageBubble(videoUrl: 'https://github.com/rafaelreis-hotmart/Audio-Sample-files/raw/master/sample.mp4', time: '10:04 am'),
              VoiceMessageBubble(audioUrl: 'https://github.com/rafaelreis-hotmart/Audio-Sample-files/raw/master/sample.mp3', duration: '0:22', time: '10:18 am', isSender: true),
              _ChatBubble('انت بتدور ورايا هو انا محور عليك ليه طيب هستفاد ايه', time: '10:18 am', isSender: true),
              VoiceMessageBubble(audioUrl: 'https://github.com/rafaelreis-hotmart/Audio-Sample-files/raw/master/sample.mp3', duration: '0:14', time: '10:23 am', isSender: false),
              _ChatBubble('صاحبي اللي في قطر قالي روح السفاره في هناك مكتب عمل قدم لهم ال CV', time: '10:26 am', isSender: false),
              _ChatBubble('السفاره قريبه منك مش بعيده مش هتخسر حاجه', time: '10:27 am', isSender: false),
            ],
          ),
          Align(
